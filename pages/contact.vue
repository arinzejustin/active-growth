  ...
  <div class="relative min-h-screen overflow-hidden">
    ...
    <main class="shell pt-28 pb-12 sm:pt-32 sm:pb-16 lg:pt-36 lg:pb-20">
      ...
      <div class="mx-auto max-w-2xl text-center">
        ...
        <h1
          class="mt-3 font-display text-4xl font-bold tracking-[-0.05em] text-ink sm:text-5xl"
        >
          Start a Conversation
        </h1>
        <p class="mt-4 text-base leading-8 text-muted sm:text-lg">
          Have questions about our programs, want to collaborate, or need
          support? Drop us a message, and our team will get back to you shortly.
        </p>
      </div>
      ...
      <div class="mx-auto mt-12 grid max-w-5xl gap-8 lg:grid-cols-5">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="surface-card rounded-[2rem] p-6 sm:p-8 space-y-6">
            ...
            <div class="space-y-4">
              <div class="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:helpdesk@activegrowthgroups.com.ng"
              ...
              <div class="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p class="text-sm font-semibold text-ink">Lagos, Nigeria</p>
                </div>
              </div>
            </div>
            ...
            <!-- Divider -->
            <div
              class="h-px w-full bg-gradient-to-r from-transparent via-line/60 to-transparent"
            />
            ...
            <div class="space-y-3">
              ...
              <div class="flex items-center gap-4">
                <a
                  href="https://www.facebook.com/share/1CT5dJBFFk/?mibextid=wwXIfr"
                  class="flex h-10 w-10 items-center justify-center rounded-xl border border-line bg-canvas/40 text-muted hover:border-accent hover:bg-accent/10 hover:text-accent transition-all duration-300"
                  aria-label="Facebook"
                >
                  <svg
                    class="h-5 w-5"
                ...
                <a
                  href="https://x.com/activegrowthgroups"
                  class="flex h-10 w-10 items-center justify-center rounded-xl border border-line bg-canvas/40 text-muted hover:border-accent hover:bg-accent/10 hover:text-accent transition-all duration-300"
                  aria-label="Twitter"
                >
                  <svg
                ...
                <a
                  href="https://www.instagram.com/active_growth_groups_?igsh=NTQ2djZjNDE5Nmlt"
                  class="flex h-10 w-10 items-center justify-center rounded-xl border border-line bg-canvas/40 text-muted hover:border-accent hover:bg-accent/10 hover:text-accent transition-all duration-300"
                ...
                <a
                  href="https://whatsapp.com/channel/0029VbDROs060eBeh1SBqO1h"
                  class="flex h-10 w-10 items-center justify-center rounded-xl border border-line bg-canvas/40 text-muted hover:border-accent hover:bg-accent/10 hover:text-accent transition-all duration-300"
                  aria-label="WhatsApp"
                >
                  <svg
        ...
        <div class="lg:col-span-3">
          <Transition name="fade" mode="out-in">
            ...
            >
              <!-- Animated checkmark -->
              <div
                class="relative flex h-20 w-20 items-center justify-center rounded-full bg-accent/10 text-accent"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                ...
                <span
                  class="absolute inset-0 animate-ping rounded-full bg-accent/15"
                />
              </div>

              <h2
                class="mt-6 font-display text-2xl font-bold tracking-tight text-ink"
              >
                Message Sent!
              </h2>
              <p class="mt-3 max-w-sm text-sm leading-6 text-muted">
                Thank you for reaching out to Active Growth Groups. We have
                received your message and will respond to you as soon as
                possible.
              </p>
            ...
            >
              <div class="grid gap-5 sm:grid-cols-2">
                ...
                <div class="space-y-1.5">
                  <label for="contact-name" class="text-xs font-bold text-muted"
                    >Full Name *</label
                  >
                  <input
                    id="contact-name"
              ...
              <div class="space-y-1.5">
                ...
                <div class="relative">
                  ...
                  <div
                    class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-4 text-muted"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
