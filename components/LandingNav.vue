...
const hideLink = (links: Array<{ label: string; href: string }>) => {
  links.forEach((link) => {
    ...
    <div class="shell pt-4">
      ...
      >
        <NuxtLink
          ...
          aria-label="Active Growth Groups home"
        >
          <span
          ...
          <div class="hidden sm:block">
            <p class="font-display text-sm font-semibold tracking-[-0.03em]">
      ...
      <div v-if="isOpen" class="surface-card mt-3 rounded-3xl p-4 lg:hidden">
