...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    public: {
      donateAccountNumber:
        process.env.NUXT_PUBLIC_DONATE_ACCOUNT_NUMBER || "2177174407",
      donateBankName:
        process.env.NUXT_PUBLIC_DONATE_BANK_NAME || "United Bank Of Africa",
      donateAccountName:
        process.env.NUXT_PUBLIC_DONATE_ACCOUNT_NAME || "Ugwu Ubasinachi Ejifor",
    },
  },
});
